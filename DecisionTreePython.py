...
from sklearn.metrics import classification_report
 ...
 balance = pd.read_csv("https://archive.ics.uci.edu/ml/machine-learning-databases/balance-scale/balance-scale.data", sep=',', header=None)
...
def importdata():
  ...
  print("Dataset: ", balance.head(10))
  return balance
  
def importdata(balance):
  print(balance.shape)
...
def train_using_entropy(trainx, testx, trainy):
